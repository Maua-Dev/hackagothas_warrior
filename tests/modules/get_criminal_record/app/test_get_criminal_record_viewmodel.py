...
class Test_GEt_Criminal_Record_ViewModel:
    def test_get_criminal_record_viewmodel(self):
        ...
        record = CriminalRecord(criminal_record_id=0, villain=villain, crimes=[CRIME_TYPE.CARRYING_RIDDLES])
        ...
        expected = {
            ...
            'villain': {
                ...
                'genre': record.villain.genre,
                'region': record.villain.region,
                'powers': record.villain.powers,
