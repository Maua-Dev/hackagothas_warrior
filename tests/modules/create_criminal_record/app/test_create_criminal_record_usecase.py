...
class Test_CreateCriminalRecordUsecase:
    def test_create_criminal_record(self):
        ...
        record_create = usecase(record)

        assert repo.criminal_records_list[-1] == record_create
    
    def test_create_criminal_record_invalid_id(self):
        repo = CriminalRecordRepositoryMock()
        usecase = CreateCriminalRecordUsecase(repo)
    ...
    def test_create_criminal_record_invalid_villain_id(self):
        repo = CriminalRecordRepositoryMock()
        usecase = CreateCriminalRecordUsecase(repo)
    ...
    def test_create_criminal_record_invalid_villain_name(self):
        repo = CriminalRecordRepositoryMock()
        usecase = CreateCriminalRecordUsecase(repo)
    ...
    def test_create_criminal_record_invalid_villain_description(self):
        repo = CriminalRecordRepositoryMock()
        usecase = CreateCriminalRecordUsecase(repo)
    ...
    def test_create_criminal_record_invalid_villain_genre(self):
        repo = CriminalRecordRepositoryMock()
        usecase = CreateCriminalRecordUsecase(repo)
    ...
    def test_create_criminal_record_invalid_villain_region(self):
        repo = CriminalRecordRepositoryMock()
        usecase = CreateCriminalRecordUsecase(repo)
    ...
    def test_create_criminal_record_invalid_villain_powers(self):
        repo = CriminalRecordRepositoryMock()
        usecase = CreateCriminalRecordUsecase(repo)
    ...
    def test_create_criminal_record_invalid_villain_is_arrested(self):
        repo = CriminalRecordRepositoryMock()
        usecase = CreateCriminalRecordUsecase(repo)
    ...
    def test_create_criminal_record_invalid_crimes(self):
        repo = CriminalRecordRepositoryMock()
        usecase = CreateCriminalRecordUsecase(repo)
